...
<div class="back2">
<p align="center" class="back2Text">Introducing the ultimate mobile app for doing stuff with your phone </p>
<p align="center" class="back2TextSmall">Blandit varius ut praesent nascetur eu penatibus nisi risus faucibus nunc ornare adipiscing nunc adipiscing. Condimentum turpis massa.
</p>
<a onclick="changeImage();"><img src="images/prva.jpg" id="back2Image" class="back2Image"></a>
</div>
<div class="back3">
	<div class="back3Margin marginFirst">
		<div class="back3Div marginFirstRight">
		<div class="pasus" >
			<img  align="center" src="images/home.png" alt="Dribbble"  height="70" width="70" class="pasusImage"><br>
...
<div class="back4">
	<div class="back4LeftDiv">
		<img src="images/druga.jpg" class="back4Image1">
		...
		<button class="back4Button" onclick="#">Sign up</button>
	</div>
	<div class="back4RightDiv">
	   <img src="images/treca.jpg" class="back4Image2">
...
<p align="center" class="footerText">&copy; Untitled. All rights reserved. Design: <a href="#" class="logoAtag">HTML5 UP</a> </p>
